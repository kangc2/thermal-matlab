...
% Matrix of all of our answers, each row is for each changed variable
answers = [];
...
% Note: Still work in progress, trying to see if using a new structure
% (sensanalysis) will be better than creating a new 'engine' structure
L = 1:0.1:3; % Length of the cylinder [m]
for i = 1:length(L)
    Eff(i) = findEfficiency2(T,Tlow, Thigh, Po, engine.rhoS, engine.mPCM, engine.a1, ...
                            L(i), engine.ar, engine.v1H, engine.v, ...
